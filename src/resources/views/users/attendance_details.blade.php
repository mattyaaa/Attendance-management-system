                ...
                <td>
                    <div class="d-flex align-items-center">
                        ...
                        <input type="text" name="time_in" 
                               value="{{ old('time_in', $attendance && $attendance->time_in ? \Carbon\Carbon::parse($attendance->time_in)->format('H:i') : '') }}" 
                               class="form-control me-2">
                        〜
                        <!-- 退勤時間 -->
                        <input type="text" name="time_out" 
                               value="{{ old('time_out', $attendance && $attendance->time_out ? \Carbon\Carbon::parse($attendance->time_out)->format('H:i') : '') }}" 
